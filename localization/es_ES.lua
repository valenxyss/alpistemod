	...
	["descriptions"] = {
		...
		["Joker"] = {
			...
			["j_prb_sneakers"] = {
				...
				["text"] = {
					"{s:1.5,C:mult,E:2}FASE ACTUAL: #6#{}",
					"{s:1.2,E:2}Con zapatillas:{}",
					"{C:blue}+1 espacio de mano.{}, {C:mult}+#2# Mult.{}",
					"Da {C:money}$#3#{} por cada carta con",
					"chachisello jugada.",
					"{s:1.2,E:2}Sin zapatillas:{}",
					"{C:blue}-1 espacio de mano.{}",
